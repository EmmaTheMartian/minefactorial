...
public class ContainerFertilizer extends AbstractMachineContainer<BlockFertilizerBE> {
    public final int capacity;
    public int fluidStackId, fluidAmount;

    public ContainerFertilizer(int containerId, Inventory playerInventory, BlockPos pos) {
        super(MFMenuTypes.FERTILIZER.get(), MFBlocks.FERTILIZER.get(), 0, containerId, playerInventory, pos);
        ...
        addDataSlot(new DataSlot() {
            @Override
            public int get() {
                return BuiltInRegistries.FLUID.getId(ContainerFertilizer.this.blockEntity.getTank().getFluid().getFluid());
            }
        ...
        addDataSlot(new DataSlot() {
            @Override
            public int get() {
                return ContainerFertilizer.this.blockEntity.getTank().getFluid().getAmount();
            }
