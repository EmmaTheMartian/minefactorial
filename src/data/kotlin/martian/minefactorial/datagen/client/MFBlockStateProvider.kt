...
class MFBlockStateProvider(event: GatherDataEvent) : DapperBlockStateProvider(event, Minefactorial.MODID) {
	...
	private val itemInputSide = blockId("item_input_side")
	private val itemInputTop = blockId("item_input_top")
	private val itemInputBottom = blockId("item_input_bottom")
	...
	override fun registerStatesAndModels() {
		...
		MFBlocks.ITEM_ROUTER.addModel(CubeModel()
			up blockId("logistics/item_router/top")
			down blockId("logistics/item_router/bottom")
			north blockId("logistics/item_router/north")
			south blockId("logistics/item_router/south")
			east blockId("logistics/item_router/east")
			west blockId("logistics/item_router/west"))
